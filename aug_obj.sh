python -u -m scripts.train.prepare_train_data --source_path=./data/working_dir/objects_violations.txt --img_dir=./data/MutatedSet/objects --label_dir=./data/MutatedSet/labels --target_dir=./data/working_dir/aug_obj_12000/
