...
python -u -m scripts.train.train --obj_path=./data/working_dir/RandomNoiseMutation/$MutateName/data/obj.data --cfg_path=./cfg/cross-hands.cfg --retrain=1 --gpu=0
