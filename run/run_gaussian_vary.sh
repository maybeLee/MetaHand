...
mkdir -p $log_dir
for MutateName in B_guassian_160_varyMutRatio_varyXY_01 B_guassian_160_varyMutRatio_varyXY_02 B_guassian_160_varyMutRatio_varyXY_03 B_guassian_160_varyMutRatio_varyXY_04 B_guassian_160_varyMutRatio_varyXY_05 B_guassian_160_varyMutRatio_varyXY_06
do
...
gpu_id=0
for MutateName in B_guassian_160_varyMutRatio_varyXY_01 B_guassian_160_varyMutRatio_varyXY_02
do
    base_dir=./data/working_dir/${MutateType}/${MutateName}_th03
