...
mutate=/root/data_company/demo/ObjactGaussianMutation/ #Company dataset变异图像的路径
...
for guass_noise in 0.3 
do
for rand_erase in 0.0 1.0
do
    ...
    python -O ./scripts/mutation/mutation_operation_demo.py --image_path $img --label_path $label --mutate_path $mutate --random_erase $rand_erase --random_erase_mode fixMutRatio_centerXY --guassian_sigma $guass_noise --object_or_background $o_or_b --dataset ${which_dataset}
done
done
