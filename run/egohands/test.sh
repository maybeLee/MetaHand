...
for std in $std_list
do
  obj_path="./data_egohands/working_dir/BackgroundGaussianMutation/BackgroundGaussian${std}_0.3/data/obj.data"
  cfg_path="./cfg/egohands.cfg"
  weights_path="./data_egohands/working_dir/BackgroundGaussianMutation/BackgroundGaussian${std}_0.3/data/backup/egohands_final.weights"
  gpu="0,1,2"
